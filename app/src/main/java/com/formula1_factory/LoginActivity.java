...
public class LoginActivity extends Activity
{
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean>
	{
		...
		protected Boolean doInBackground(Void... params)
		{
			...
			try
			{
				jsonAccountInfo = dataManager.getDataFromDB(
			...
			return accountInfo.get("password").equals(mPassword);
		}
		...
		protected void onPostExecute(final Boolean success)
		{
			...
			if (success)
			{
				Intent mainActivityIntent = new Intent(getApplicationContext(),
						MainActivity.class);
				mainActivityIntent.putExtra("clientID", accountInfo.get("client_id"));
